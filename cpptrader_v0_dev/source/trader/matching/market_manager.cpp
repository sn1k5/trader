...
{
    std::cout << "[DEBUG] MarketManager::AddSymbol id=" << symbol.Id << std::endl;
...
{
    std::cout << "[DEBUG] MarketManager::DeleteSymbol id=" << id << std::endl;
...
{
    std::cout << "[DEBUG] MarketManager::AddOrderBook symbol_id=" << symbol.Id << std::endl;
...
{
    std::cout << "[DEBUG] MarketManager::AddOrder id=" << order.Id << " symbol=" << order.SymbolId
...
{
    std::cout << "[DEBUG] MarketManager::ReduceOrder id=" << id << " qty=" << quantity << std::endl;
...
{
    std::cout << "[DEBUG] MarketManager::ModifyOrder id=" << id << " price=" << new_price << " qty=" << new_quantity << std::endl;
...
{
    std::cout << "[DEBUG] MarketManager::MitigateOrder id=" << id << " price=" << new_price << " qty=" << new_quantity << std::endl;
...
{
    std::cout << "[DEBUG] MarketManager::ReplaceOrder id=" << id << " new_id=" << new_id
              << " price=" << new_price << " qty=" << new_quantity << std::endl;
...
{
    std::cout << "[DEBUG] MarketManager::DeleteOrder id=" << id << std::endl;
...
{
    std::cout << "[DEBUG] MarketManager::ExecuteOrder id=" << id << " qty=" << quantity << std::endl;
...
{
    std::cout << "[DEBUG] MarketManager::ExecuteOrder id=" << id << " price=" << price << " qty=" << quantity << std::endl;
...
{
    std::cout << "[DEBUG] MarketManager::Match symbol_id=" << order_book_ptr->symbol().Id << std::endl;
