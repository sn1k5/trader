...
public class ModifyOrderRequest extends ProtocolMessage {
    ...
    public ModifyOrderRequest(long id, long newPrice, long newQuantity) {
        super(ProtocolConstants.MODIFY_ORDER_REQ, ProtocolConstants.FLAG_REQUEST);
        this.id = id;
